...
export default function FloatingContact() {
  return (
    <div className="fixed right-4 bottom-24 z-50 flex flex-col gap-3">
      <a
        href={telLink}
        className="bg-secondary text-secondary-foreground hover:shadow-secondary/40 flex h-12 w-12 items-center justify-center rounded-full border border-white/30 shadow-lg transition-transform duration-200 hover:scale-105"
